...
export class AppsClient implements IAppsClient {
	...
	add(
		...
		version: string,
		arch: AppArch,
		content?: FileParameter | null | undefined,
		cancelToken?: CancelToken | undefined,
		options?: AxiosRequestConfig
	): Promise<void> {
		let url_ = this.baseUrl + "/api/apps/{app}/{arch}/{version}";
		if (app === undefined || app === null) throw new Error("The parameter 'app' must be defined.");
		...
		if (arch === undefined || arch === null) throw new Error("The parameter 'arch' must be defined.");
		url_ = url_.replace("{arch}", encodeURIComponent("" + arch));
		url_ = url_.replace(/[?&]$/, "");

		const content_ = new FormData();
		if (content !== null && content !== undefined) content_.append("content", content.data, content.fileName ? content.fileName : "content");
