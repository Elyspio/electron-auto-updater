...
namespace AutoUpdater.Abstractions.Interfaces.Injections;

public interface IDotnetModule
{
	/// <summary>
	///     Chargement des enregistrements dans les services .Net AutoUpdater.Core.
	/// </summary>
...
{
	/// <summary>
	///     Register an entire module .Net AutoUpdater.Core services.
	/// </summary>
